# 2020
# The ADWXD Toolkit was programmed and developed by Taguar258.
# The ADWXD Toolkit is published under the MIT Licence.
# The ADWXD Toolkit is based on the CLIF-Framework.
...
THE USER ALONE IS RESPONSIBLE, BE IT: ABUSING ADWXD
TO FIT ILLEGAL PURPOSES OR ACCIDENTAL DAMAGE CAUSED BY ADWXD.
BY USING THIS SOFTWARE, YOU MUST AGREE TO TAKE FULL RESPONSIBILITY
FOR ANY DAMAGE CAUSED BY ADWXD.
EVERY ATTACK WILL CAUSE TEMPORARY DAMAGE, BUT LONG-TERM DAMAGE IS
DEFFINITIFLY POSSIBLE.
ADWXD SHOULD NOT SUGGEST PEOPLE TO PERFORM ILLEGAL ACTIVITIES.
